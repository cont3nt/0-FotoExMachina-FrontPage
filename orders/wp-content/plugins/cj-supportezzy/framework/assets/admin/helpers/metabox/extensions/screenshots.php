<?php
// Fill Address
add_action( 'cmb_render_screenshots', 'cjsupport_cmb_render_screenshots', 10, 5 );
function cjsupport_cmb_render_screenshots( $field_args, $escaped_value, $object_id, $object_type, $field_type_object ) {
    ...
    echo cjsupport_cmb_render_screenshots_styles($field_args['id']);
}



function cjsupport_cmb_render_screenshots_styles($id){ ?>
    <style type="text/css">
