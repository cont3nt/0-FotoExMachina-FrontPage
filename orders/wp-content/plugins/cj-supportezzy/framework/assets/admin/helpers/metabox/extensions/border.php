<?php
// Border
add_action( 'cmb_render_border', 'cjsupport_cmb_render_border', 10, 5 );
function cjsupport_cmb_render_border( $field_args, $escaped_value, $object_id, $object_type, $field_type_object ) {
    ...
    echo '<label for="'.$field_args['id'].'_border_top" style="margin-bottom:5px; display:inline-block;">'.__('Border Top (px)', 'cjsupport').'</label><br>';
    ...
    echo '<div class="margin-5-bottom one_sixth">';
    echo '<label for="'.$field_args['id'].'_border_right" style="margin-bottom:5px; display:inline-block;">'.__('Border Right (px)', 'cjsupport').'</label><br>';
    ...
    echo '<div class="margin-5-bottom one_sixth">';
    echo '<label for="'.$field_args['id'].'_border_bottom" style="margin-bottom:5px; display:inline-block;">'.__('Border Bottom (px)', 'cjsupport').'</label><br>';
    ...
    echo '<div class="margin-5-bottom one_sixth">';
    echo '<label for="'.$field_args['id'].'_border_left" style="margin-bottom:5px; display:inline-block;">'.__('Border Left (px)', 'cjsupport').'</label><br>';
    ...
    echo '<div class="margin-5-bottom one_sixth">';
    echo '<label for="'.$field_args['id'].'_border_styles" style="margin-bottom:5px; display:inline-block;">'.__('Border Style', 'cjsupport').'</label><br>';
    echo '<select id="'.$field_args['id'].'_border_styles" name="'.$field_args['id'].'[border-style]" style="width:100%;">';
    foreach (cjsupport_border_styles() as $key => $value) {
    ...
    echo '<label for="'.$field_args['id'].'_border_color" style="margin-bottom:5px; display:inline-block;">'.__('Border Color (#HEX)', 'cjsupport').'</label><br>';
