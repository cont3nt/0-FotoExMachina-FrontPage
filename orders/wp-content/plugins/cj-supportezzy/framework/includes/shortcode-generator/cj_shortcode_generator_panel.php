...
*/
	...
	$cj_products_array[] = '<option value="0">'.__('Select Product', 'cjsupport').'</option>';
		...
		<div class="panel panel-default" style="border-bottom: none; box-shadow: none;">
			...
			<div class="panel-body" style="border-bottom: 1px solid #ddd;">
				<div class="clearfix">
					...
					<select id="cj-sg-select-shortcode" data-no-shortcode="<?php _e('Select a shortcode to configure settings and insert.', 'cjsupport'); ?>" style="width: 100%; display:none; margin-top:10px;"></select>
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div id="cj-sg-dynamic-content" class="clearfix" style="display:none;">
					<div class="alert alert-warning">
						<?php _e('Select a shortcode to configure settings and insert.', 'cjsupport'); ?>
					</div>
				</div>
			</div>
		</div>
