...
foreach ($options as $key => $option) {
	...
	if($option['type'] == 'padding'){
		...
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Top', 'cjsupport').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Top', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$top.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Bottom', 'cjsupport').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Bottom', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$bottom.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Left', 'cjsupport').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Left', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$left.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Right', 'cjsupport').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Right', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$right.'" /></div>';
		$display[] = '</div>';
		$display[] = '<div class="cj-info">'.__($option['info'], 'cjsupport').'</div>';
		$display[] = '</td>';
		$display[] = '</tr>';
	...
	if($option['type'] == 'border'){
		...
		$display[] = '<td class="cj-panel padding-10-top">';
		$display[] = '<div class="clearfix">';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Top', 'cjsupport').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Top', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$top.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Bottom', 'cjsupport').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Bottom', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$bottom.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Left', 'cjsupport').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Left', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$left.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Right', 'cjsupport').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Right', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$right.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Style', 'cjsupport').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Right', 'cjsupport').'" type="text" name="'.$option['id'].'[]" value="'.$style.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Color', 'cjsupport').'</label>';
	...
	if($option['type'] == 'groupdropdown' || $option['type'] == 'groupselect'){
		$opts[] = '<option>'.__('Select', 'cjsupport').' '.__($option['label'], 'cjsupport').'</option>';
		foreach ($option['options'] as $okey => $ovalue) {
	...
	if($option['type'] == 'file_raw'){
		...
		$display[] = '<td class="cj-panel">';
		$display[] = '<div class="cj-file-upload">';
		$display[] = '<button class="button-secondary">'.__('Choose File', 'cjsupport').'</button>';
	...
	if($option['type'] == 'files_raw'){
		...
		$display[] = '<td class="cj-panel">';
		$display[] = '<div class="cj-file-upload">';
		$display[] = '<button class="button-secondary">'.__('Choose Files', 'cjsupport').'</button>';
	...
	if($option['type'] == 'sortable'){
		...
		$opts = null;
		if($option['default'] != ''){
			$opts = cjsupport_sortArrayByArray($option['options'], $option['default']);
		}else{
			$opts = $option['options'];
		}
	...
	if($option['type'] == 'submit'){
		...
		$display[] = '<input '.$params.' type="submit" id="'.$option['id'].'" name="'.$option['id'].'" value="'.__($option['label'], 'cjsupport').'" class="button-primary" />'.$option['suffix'];
		$display[] = '</td>';
		$display[] = '</tr>';
	}
