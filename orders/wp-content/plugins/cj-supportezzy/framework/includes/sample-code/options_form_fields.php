...
$cjsupport_item_options['form_fields'] = array(
	array(
		'type' => 'hidden',
		...
		'suffix' => '',
		'prefix' => '',
		'default' => __('This is text that goes here..', 'cjsupport'),
	...
	array(
		...
		'suffix' => '',
		'prefix' => '',
		'default' => __('HTML Form Fields', 'cjsupport'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'info-full',
		'id' => 'ff_info_full',
		'label' => __('Info Full Label', 'cjsupport'),
		'info' => '',
		'suffix' => '',
		'prefix' => '',
		'default' => __('Info Full default text', 'cjsupport'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'info',
		'id' => 'ff_info',
		'label' => __('Info Label', 'cjsupport'),
		'info' => '',
		'suffix' => '',
		'prefix' => '',
		'default' => __('Info default text', 'cjsupport'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'text',
		'id' => 'ff_text',
		'label' => __('Textbox', 'cjsupport'),
	...
	array(
		...
		'label' => __('Checkbox Inline', 'cjsupport'),
		'info' => 'This is some info about this field.',
		'suffix' => '',
		'prefix' => '',
	...
	array(
		'type' => 'radio-inline',
		'id' => 'ff_radio_inline',
		'label' => __('Radio Inline', 'cjsupport'),
		'info' => 'This is some info about this field.',
		'suffix' => '',
		'prefix' => '',
		'default' => 'no',
	...
	array(
		'type' => 'multiselect',
		'id' => 'ff_multiselect',
		'label' => __('MultiSelect', 'cjsupport'),
		'info' => 'This is some info about this field.',
		'suffix' => '',
		'prefix' => '',
		'default' => array('no', 'may-be'),
	...
	array(
		...
		'suffix' => '',
		'prefix' => '',
		'default' => __('WordPress Fields', 'cjsupport'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'page',
	...
	array(
		...
		'suffix' => '',
		'prefix' => '',
		'default' => __('Helper Form Fields', 'cjsupport'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'date',
