 ...
 * @version FW-20150208
*/
function cjsupport_add_dashboard_widgets() {
	wp_add_dashboard_widget(
                 'cjsupport_dashboard_widget',         // Widget slug.
                 'cjsupport',         // Title.
                 'cjsupport_dashboard_widget_content' // Display function.
        );
}
// add_action( 'wp_dashboard_setup', 'cjsupport_add_dashboard_widgets' );

function cjsupport_dashboard_widget_content() {
